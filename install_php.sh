...
./configure --with-apxs2=/usr/local/apache2/bin/apxs --with-gettext --with-mysqli --with-imap --with-zlib --with-gd  --with-curl --with-kerberos --with-imap-ssl --with-openssl --enable-mbstring 
make 
make install
# Clean up
rm -rf /tmp/php*
